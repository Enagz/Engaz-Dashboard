...
import ServicesPrices from "@/components/tables/ServicesPrices";
...
const costsSummary = [
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="m12.334 6.667 1 1-5.667 5.666-1-1zm-9-3.334h13.333A1.66 1.66 0 0 1 18.334 5v3.333a1.667 1.667 0 1 0 0 3.334V15c0 .925-.742 1.667-1.667 1.667H3.334A1.667 1.667 0 0 1 1.667 15v-3.333a1.667 1.667 0 1 0 0-3.333V5a1.667 1.667 0 0 1 1.667-1.667m0 1.667v2.117a3.328 3.328 0 0 1 0 5.766V15h13.333v-2.117a3.33 3.33 0 0 1 0-5.766V5zm4.583 1.667c.692 0 1.25.558 1.25 1.25 0 .691-.558 1.25-1.25 1.25s-1.25-.559-1.25-1.25c0-.692.558-1.25 1.25-1.25m4.167 4.166a1.25 1.25 0 1 1 0 2.5c-.692 0-1.25-.558-1.25-1.25 0-.691.558-1.25 1.25-1.25"
          fill="#3E97D1"
        />
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M15.833 16.667H4.167A1.667 1.667 0 0 1 2.5 15V7.5a1.667 1.667 0 0 1 1.667-1.667h11.666A1.666 1.666 0 0 1 17.5 7.5V15a1.666 1.666 0 0 1-1.667 1.667Z"
          stroke="#3E97D1"
          strokeWidth={1.5}
        />
        <path
...
const Costs = () => {
  ...
  return role === "owner" ? <OwnerView /> : <EmployeeView />;
};
...
const EmployeeView = () => {
  return (
    <div className="flex flex-col gap-y-8">
      {/* section */}
      <div className="flex flex-col gap-y-6">
        <p className="font-semibold text-2xl">ملخص التكاليف</p>

        <div className="flex flex-row flex-wrap items-center gap-4 md:gap-8">
          {costsSummary.map((item) => (
            <Card key={item.title} {...item} color="#EDEEFC" />
          ))}
        </div>
      </div>
      ...
      {/* section */}
      <div className="flex flex-col gap-y-6">
        <p className="font-semibold text-2xl">أسعار الخدمات</p>
      ...
      {/* section */}
      <div className="flex flex-col gap-y-6">
        <p className="font-semibold text-2xl">تحليل التكاليف والأسعار</p>
